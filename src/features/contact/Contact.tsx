...
export function Contact() {
  return (
    <Section id="contact" className="bg-slate-50 dark:bg-slate-950" ariaLabel="Contact and certifications">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Contact Me</h3>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-slate-800 dark:text-slate-200 font-medium">{contact.email}</p>
                </div>
              </a>
              ...
              >
                <div className="w-10 h-10 bg-indigo-500/10 rounded-lg flex items-center justify-center group-hover:bg-indigo-500/20 transition-colors">
                  <FiLinkedin className="text-indigo-600 dark:text-indigo-400 text-lg" />
                </div>
                <div>
              ...
              >
                <div className="w-10 h-10 bg-indigo-500/10 rounded-lg flex items-center justify-center group-hover:bg-indigo-500/20 transition-colors">
                  <FiGithub className="text-indigo-600 dark:text-indigo-400 text-lg" />
                </div>
                <div>
              ...
              {certifications.map((cert) => (
                ...
                >
                  <div className="flex items-start justify-between">
                    <div>
                      <h4 className="text-slate-900 dark:text-slate-100 font-semibold">{cert.title}</h4>
                      <p className="text-slate-500 dark:text-slate-400 text-sm mt-0.5">
                        {cert.issuer} · {cert.date}
                      </p>
                    </div>
                    <FiExternalLink className="text-blue-500 dark:text-blue-400 shrink-0 mt-1" />
                  </div>
                  <div className="flex flex-wrap gap-1.5 mt-3">
                    {cert.skills.map((skill) => (
                      <span
                        key={skill}
                        className="text-xs font-medium bg-blue-100 text-blue-700 dark:bg-blue-500/10 dark:text-blue-300 px-2 py-0.5 rounded"
                      >
                        {skill}
                      </span>
                    ))}
